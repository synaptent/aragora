---
title: Verify an Aragora decision receipt in 60 seconds
description: Verify an Aragora decision receipt in 60 seconds
---
...
Every receipt is an [Open Decision Receipt](../specs/open-decision-receipt)
