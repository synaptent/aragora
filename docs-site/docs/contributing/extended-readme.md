...
**Scale:** 4,327 tracked Python files | 145 top-level modules | 226,793 test functions across 5,607 test files | canonical counts in [METRICS.md](https://github.com/synaptent/aragora/blob/main/docs/METRICS.md)
<!-- metrics:end -->
