...
**Scale:** 4,332 tracked Python files | 145 top-level modules | 227,127 test functions across 5,623 test files | canonical counts in [METRICS.md](https://github.com/synaptent/aragora/blob/main/docs/METRICS.md)
<!-- metrics:end -->
