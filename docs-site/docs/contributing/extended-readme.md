...
**Scale:** 4,331 tracked Python files | 145 top-level modules | 226,797 test functions across 5,595 test files | canonical counts in [METRICS.md](https://github.com/synaptent/aragora/blob/main/docs/METRICS.md)
<!-- metrics:end -->
...
- the `aragora.server` module entrypoint remains available for scripts/automation (`aragora serve` is the canonical equivalent)
...
The server exposes 3,205 API operations across 2,912 paths. Key categories:
<!-- metrics:end -->
