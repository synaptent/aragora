...
**Scale:** 4,330 tracked Python files | 145 top-level modules | 227,424 test functions across 5,645 test files | canonical counts in [METRICS.md](https://github.com/synaptent/aragora/blob/main/docs/METRICS.md)
<!-- metrics:end -->
