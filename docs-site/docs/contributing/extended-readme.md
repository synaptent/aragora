...
**Scale:** 4,331 tracked Python files | 145 top-level modules | 227,501 test functions across 5,649 test files | canonical counts in [METRICS.md](https://github.com/synaptent/aragora/blob/main/docs/METRICS.md)
<!-- metrics:end -->
