---
title: Roadmap Intake Register
description: Roadmap Intake Register
---
...
|---|---|
| High-level direction | [`ROADMAP.md`](./roadmap) |
| Goals / north stars | [`docs/CANONICAL_GOALS.md`](./canonical-goals) |
| Near-term execution order | [`docs/status/NEXT_STEPS_CANONICAL.md`](./next-steps-canonical) |
| Tracked epics/milestones | [`docs/status/ACTIVE_EXECUTION_ISSUES.md`](./active-execution-issues) |
| Feature backlog (P0–P5) | [`docs/FEATURE_GAP_LIST.md`](./feature-gap-list) |
