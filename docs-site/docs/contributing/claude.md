...
**Codebase Scale:** 4,266 tracked Python files | 144 top-level modules | 223,561 test functions | 5,455 test files | 3,297 API operations across 2,870 paths | canonical counts in `docs/METRICS.md`
<!-- metrics:end -->
...
**Test Suite:** 223,561 test functions across 5,455 test files (canonical counts in `docs/METRICS.md`)
<!-- metrics:end -->
