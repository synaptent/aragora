...
const DOC_MAP = {
  ...
  // Disagreement Atlas, included by the autogenerated Reference sidebar.
  'atlas/README.md': 'reference/atlas/overview.md',
  'atlas/summary.md': 'reference/atlas/summary.md',
...
const REPO_MARKDOWN_LINKS = {
  ...
  'architecture/agent-operating-loop.md':
    `${REPO_BLOB_BASE}/docs/architecture/agent-operating-loop.md`,
