...
> **Last Updated:** 2026-09-25 (v2.11.0 alignment with repo versions)
...
|-----|---------|---------|----------|
| TypeScript (`@aragora/sdk`) | 2.11.0 | 380 async | Full API (79 namespaces) |
| Python (`aragora`) | 2.11.0 | 220 async + 420 sync | Full API |
...
| [MCP README](../../aragora/mcp/README.md) | MCP server tools and setup | AI tool integration via MCP |
