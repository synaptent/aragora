...
| Telegram | Stable | Commands + webhooks |
| WhatsApp | Stable | Meta/Twilio APIs |
| Voice (STT) | Stable | Whisper transcription |
| Documents | Stable | PDF, Word, Excel, PowerPoint, code, markdown |
...
| Voice (TTS) | Stable | ElevenLabs, Edge-TTS, Polly |
...
- [ ] n8n workflow nodes
- [x] LangChain integration (callbacks, chains, retriever, tools in `aragora/integrations/langchain/`)
- [x] Custom MCP servers (`aragora/mcp/server.py`, `aragora/mcp/tools.py`)
...
|---------|------|------------|
| 2.8.0 | 2026-02-25 | 213K+ tests, 0 mypy errors, SDK parity (184/183), 45 KM adapters, 43 agent types, 390+ RBAC permissions, 98% GA |
