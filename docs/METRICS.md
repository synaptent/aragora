...
| Test functions (class + module level) | `227100` | `tests/` | `git grep -E '^[[:space:]]*(async )?def test_' -- tests \| wc -l` |
| @pytest.mark.parametrize decorators | `1352` | `tests/` | `git grep -E '@pytest\.mark\.parametrize' -- tests \| wc -l` |
