...
| Test functions (class + module level) | `227124` | `tests/` | `git grep -E '^[[:space:]]*(async )?def test_' -- tests \| wc -l` |
| @pytest.mark.parametrize decorators | `1341` | `tests/` | `git grep -E '@pytest\.mark\.parametrize' -- tests \| wc -l` |
