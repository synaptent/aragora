...
|---|---|---|
| M0 | scoreboard, import-cycle repair, Atlas v1, release 2.10.0, drift paydown batch 1 | **Done** 2026-09-13: v2.10.0 tagged 2026-09-04 ([#9977](https://github.com/synaptent/aragora/pull/9977)); Atlas v1 merged ([#9951](https://github.com/synaptent/aragora/pull/9951)); mutual import cycles 144 → 138 (≤140); import-cycle ratchet merged 2026-09-11 ([#9949](https://github.com/synaptent/aragora/pull/9949)); batch 1 [#9979](https://github.com/synaptent/aragora/pull/9979) operator-settled and merged 2026-09-13 as `74c22b58` after the legacy `items[]` rows were reconciled (batch-1 exception to VAL-DRIFT-002.3) and both families re-reviewed. Batch 2 [#10013](https://github.com/synaptent/aragora/pull/10013) now rebases onto `main` and needs one superseding packet |
