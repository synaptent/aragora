...
For native ESLint suppressions, count means file/rule pairs; occurrence
counts and the number of files are recorded separately below.
...
| Date | File | Reason | Census |
|---|---|---|---|
| 2026-09-10 | `aragora/live/eslint-suppressions.json` | Initial adoption of naming and complexity gates, generated with `npx eslint . --suppress-all` then pruned; preserve existing behavior while rejecting new debt. No boundary or warning suppressions. | 335 files, 339 file/rule pairs, 426 occurrences (23 naming, 403 complexity) |
