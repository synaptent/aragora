...
> **Agent-facing projection:** [Agent Operating Loop](../architecture/agent-operating-loop.md) composes roadmap, mission, work, and Nomic truth without creating a second control plane.
...
- [ROADMAP.md](../../ROADMAP.md) is the short external/internal doorway.
- [CANONICAL_GOALS.md](../CANONICAL_GOALS.md) defines the product boundary.
...
- [NEXT_STEPS_CANONICAL.md](../status/NEXT_STEPS_CANONICAL.md) defines the current tranche.
- [ACTIVE_EXECUTION_ISSUES.md](../status/ACTIVE_EXECUTION_ISSUES.md) holds the epic/milestone/execution tree.
